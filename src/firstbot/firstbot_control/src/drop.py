...
for i in range(10):
    ...
    final_time = getWorldProp().sim_time + 4.0
    ...
    print(str(getWorldProp().sim_time)+","+str(ls.getLinkPose('firstbot_ball::ball').position.x)+","+str(ls.getLinkPose('firstbot_ball::ball').position.y))
